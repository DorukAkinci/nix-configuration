...
hs.hotkey.bind({ "ctrl", "cmd" }, "1", hs.fnutils.partial(winresize, "left"))
hs.hotkey.bind({ "ctrl", "cmd" }, "2", hs.fnutils.partial(winresize, "down"))
hs.hotkey.bind({ "ctrl", "cmd" }, "3", hs.fnutils.partial(winresize, "up"))
hs.hotkey.bind({ "ctrl", "cmd" }, "4", hs.fnutils.partial(winresize, "right"))

-- Center of the screen
-- hs.hotkey.bind({ "ctrl", "cmd" }, "C", center)

-- Thirds of the screen
hs.hotkey.bind({ "ctrl", "alt" }, "1", left_third)
hs.hotkey.bind({ "ctrl", "alt" }, "2", down_third)
hs.hotkey.bind({ "ctrl", "alt" }, "3", up_third)
hs.hotkey.bind({ "ctrl", "alt" }, "4", right_third)

-- Maximized
-- hs.hotkey.bind({ "ctrl", "alt", "cmd" }, "F", hs.fnutils.partial(winresize, "max"))
hs.hotkey.bind({ "ctrl", "alt", "cmd" }, "3", hs.fnutils.partial(winresize, "max"))

-- Move between screens
hs.hotkey.bind({ "ctrl", "alt", "cmd" }, "1", hs.fnutils.partial(winmovescreen, "left"))
hs.hotkey.bind({ "ctrl", "alt", "cmd" }, "4", hs.fnutils.partial(winmovescreen, "right"))
